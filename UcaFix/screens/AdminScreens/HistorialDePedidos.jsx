    ...
    <View style={styles.back}>
      ...
      >
        ...
        <View style={styles.requestInfo}>
          ...
          <Text style={styles.requestText}>Arreglado por: {`${item.fixer}`}</Text>
          {selectedRequest === item.id && (
            <View style={styles.detailsContainer}>
              ...
              />
              <Text style={styles.detailsText}>{`${item.building}`}</Text>
              <Text style={styles.detailsText}>{item.details}</Text>
              <Text style={styles.pedidoDescripcion}>Imagen del arreglo</Text>
              <Image
                style={styles.UcaLogo}
                source={{
                  uri: item.uploadedPicture
